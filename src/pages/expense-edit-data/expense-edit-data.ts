...
/**
 * Generated class for the ExpenseEditDataPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-expense-edit-data',
  templateUrl: 'expense-edit-data.html',
})
export class ExpenseEditDataPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad ExpenseEditDataPage');
  }
